...
/**
 * Cache for subscriberMethods that are annotated with {@code @Subscribe} in a
 * given class and all its super-classes. And typeHierarchy cache with all
 * super-classes and interfaces for a concrete class.
 */
public interface SubscriberLoader {
     ...
     */
    Iterable<Method> findSubscriberMethods(Class<?> clazz);
